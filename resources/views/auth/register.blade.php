                ...
                <form action="{{route('auth.register')}}" method="post">
                    ...
                    @auth()
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{auth()->user()->avatar}}" class="avatar-sm rounded-circle"
                                 disabled alt="">
                        </div>
                        <div class="form-group">
                            <label for="fullname">Full Name</label>
                            <input class="form-control" type="text" id="fullname" name="name" disabled
                                   value="{{auth()->user()->name}}">
                        </div>
                        <div class="form-group">
                            <label for="emailaddress">Email address</label>
                            <input class="form-control" type="email" id="emailaddress" name="email" disabled
                                   value="{{auth()->user()->email}}">
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="applicant" value="1" name="role" class="custom-control-input"
                                       checked>
                                <label class="custom-control-label" for="applicant">Applicant</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="hr" value="2" name="role" class="custom-control-input">
                    ...
                    @guest()
                        <div class="form-group">
                            <label for="fullname">Full Name</label>
                            <input class="form-control" type="text" id="fullname" name="name" required value="">
                        </div>
                        <div class="form-group">
                            <label for="emailaddress">Email address</label>
